    ...
    <body>
        ...
        <div class="container border p-4" style="max-width: 400px; border-radius: 10px;"> 
            ...
            <div class="text-center">
                ...
                <a href="/Lista-02/Lista-02/Atv-10/atv-10.html" class="btn btn-secondary mt-2 col-sm-5" style="background-color: lightskyblue; border-color: black; color: black;">Próximo</a>
            </div> 
        </div>
    </body>
</html>